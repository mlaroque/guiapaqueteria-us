...
<table class="shadow">
  <thead>
    <tr>
      <th class="text-center" colspan="4"><?php $titulo_tabla; ?></th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      <td>
        ...
        <?php $linea_tabla->servicio; ?>
      </td>
      <td>
        <p class="tabTit">Precio</p>
        <?php $linea_tabla->precio; ?>
      </td>
      <td>
        <p class="tabTit">Entrega en</p>
        <?php $linea_tabla->entrega_en; ?>
      </td>
      <td>
        <p class="tabTit">Entrega a</p>
        <?php $linea_tabla->entrega_a; ?>
      </td>
    </tr>  
    <?php endforeach; ?>  
  </tbody>
